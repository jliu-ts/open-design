...
${prompt}`
    ...
    // 3. Extract the HTML block and write to index.html if present, otherwise output text directly
    ...
    if (match && match[1]) {
      ...
      console.error('No HTML block found; outputting conversational text / question-form directly.');
    }
